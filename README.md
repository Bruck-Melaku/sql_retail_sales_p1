...
1. **Write a SQL query to retrieve the total amount of sales**:
```sql
SELECT COUNT(*)
AS Total_Sales
FROM retail_sales;
...
2. **Write a SQL query to retrieve the total amount of customers**
```sql
...
## Note - 
I would like to thank Zero Analyst for providing the data, and also for his help in guiding me in this project
